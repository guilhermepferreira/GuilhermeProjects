...
namespace Primeiro.Services.Implementations
{
    public class TokenService : ITokenInterface
    {
        ...
        {
            var tokenValidationarameters = new TokenValidationParameters
            {
            ...
            var principal = tokenHandler.ValidateToken(token, tokenValidationarameters, out securityToken);
